...
class ComprasEnc(models.Model):
    ...
    no_factura=models.CharField(max_length=100, default='011-022-34853')
    fecha_factura=models.DateField(null=True,blank=True, default='2020-06-28')
...
db_logger.error('error mensaje')
db_logger.critical('critical mensaje')
